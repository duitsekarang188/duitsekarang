...
export default function HomePage() {
  // Default set ke RM500 & 30 hari untuk memadankan sampel RM507.50 secara automatik pada muatan pertama
  ...
  const senaraiPelanggan = [
    ...
    { nama: "En. Wei Jie ****", amaun: "1,500", lokasi: "Cheras" },
    { nama: "Cik Siti Aishah ****", amaun: "3,000", lokasi: "Balakong" },
    { nama: "En. Ming Xuan ****", amaun: "800", lokasi: "Gombak" },
    { nama: "Pn. Farhana ****", amaun: "2,500", lokasi: "Klang" },
    { nama: "En. Mohd Abu ****", amaun: "2,100", lokasi: "Subang Jaya" },
    { nama: "Pn. Wei Ting ****", amaun: "700", lokasi: "Bangi" },
    { nama: "En. Thomas Deng ****", amaun: "1,300", lokasi: "Nilai" },
    { nama: "Cik Meera****", amaun: "2,200", lokasi: "Semenyih" },
    { nama: "En. Mohd Asri ****", amaun: "900", lokasi: "Kuala Lumpur" },
    { nama: "Pn. Evelyn ****", amaun: "2,200", lokasi: "Bukit Jalil" },	
    { nama: "Pn. Dewi ****", amaun: "500", lokasi: "Kajang" },
    { nama: "En. Lim Koh ****", amaun: "1,500", lokasi: "Puchong" },
    { nama: "Cik Kavita ****", amaun: "3,000", lokasi: "Petaling Jaya" },
    { nama: "En. Vikram ****", amaun: "800", lokasi: "Selayang" },
    { nama: "Pn. Farhana ****", amaun: "2,500", lokasi: "Seri Kembangan" }			
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0F1E36] via-[#0B1528] to-[#040814] text-slate-100 font-sans antialiased selection:bg-orange-500 selection:text-white relative overflow-x-hidden">
      ...
      {/* 6. SEKSYEN BARU: EXAMPLE CALCULATOR (SAMA SEBIJI SEPERTI image_6eb9a5.png - DIALIKAN KE SINI & DISESUAIKAN WARNA) */}
      <section className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 border-t border-b border-slate-900/60 bg-[#060D1A]">
        <div className="grid md:grid-cols-12 gap-6 items-stretch">
          
          {/* Kad Kiri: Dark Theme Premium Term Card (Sebelumnya Forest Green) */}
          <div className="md:col-span-4 bg-gradient-to-b from-[#112240] to-[#0A162B] p-8 sm:p-10 rounded-[2rem] flex flex-col justify-center text-center space-y-6 shadow-2xl border border-blue-500/10">
            ...
            <div className="space-y-4">
              <div>
                <p className="text-cyan-400 text-xs uppercase tracking-wider font-bold">Tempoh pembiayaan minimum:</p>
                <p className="text-white text-xl font-black mt-1">30 hari</p>
              </div>
              
              <div className="pt-4 border-t border-slate-800/80">
                <p className="text-cyan-400 text-xs uppercase tracking-wider font-bold">Tempoh pembiayaan maksimum:</p>
                <p className="text-white text-sm sm:text-base font-semibold leading-relaxed mt-2">
                  30 hari untuk pembiayaan pertama dan 180 hari bagi pembiayaan ulangan
                </p>
              </div>
            </div>
          </div>

          {/* Kad Kanan: Dark Theme Example Calculation List Card (Sebelumnya Putih) */}
          <div className="md:col-span-8 bg-[#0E1B30] border border-slate-800 p-8 sm:p-10 rounded-[2rem] flex flex-col justify-between space-y-6 shadow-2xl text-slate-300">
            
            <div className="space-y-3">
              <span className="text-orange-400 font-extrabold text-xs uppercase tracking-wider block">Contoh Simulasi</span>
              <h3 className="text-2xl sm:text-3xl font-black text-white tracking-tight leading-none">
                Simulasi pengiraan pembiayaan adalah seperti berikut:
              </h3>
            </div>

            {/* List Row dengan Dotted Connector Line */}
            <div className="space-y-4 text-sm sm:text-base font-bold text-slate-350 pt-2">
              <div className="flex justify-between items-end">
                <span>Jumlah pembiayaan:</span>
                <span className="border-b border-dotted flex-grow mx-3 mb-1.5 border-slate-700"></span>
                <span className="text-white font-black">RM 1,000</span>
              </div>
              <div className="flex justify-between items-end">
                <span>Tempoh pembiayaan:</span>
                <span className="border-b border-dotted flex-grow mx-3 mb-1.5 border-slate-700"></span>
                <span className="text-white font-black">30 hari</span>
              </div>
              <div className="flex justify-between items-end">
                <span>Kadar keuntungan (18% / setahun):</span>
                <span className="border-b border-dotted flex-grow mx-3 mb-1.5 border-slate-700"></span>
                <span className="text-emerald-450 font-black">RM 14.79</span>
              </div>
              <div className="flex justify-between items-end">
                <span>Jumlah bayaran balik:</span>
                <span className="border-b border-dotted flex-grow mx-3 mb-1.5 border-slate-700"></span>
                <span className="text-orange-400 font-black">RM 1,014.79</span>
              </div>
            </div>
            ...
            <div className="pt-6 border-t border-slate-800/60 space-y-2">
              <p className="text-emerald-400 font-extrabold text-xs sm:text-sm">
                Kadar keuntungan tetap 18% setahun terpakai untuk semua nilai pembiayaan yang diluluskan
              </p>
              <p className="text-slate-400 text-xs leading-relaxed font-medium">
                DuitSekarang tidak memaksa anda untuk melunaskan pembiayaan dalam tempoh 30 hari sahaja.
              </p>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 pt-12 text-left">
            <div className="p-8 bg-[#0E1B30] rounded-3xl border border-slate-800 flex flex-col justify-between space-y-6">
              ...
              <div className="flex items-center gap-3 border-t border-slate-800 pt-4">
                <div className="w-10 h-10 rounded-full bg-orange-500/20 flex items-center justify-center text-orange-400 font-bold">KM</div>
                <div>
                  <div className="font-bold text-white text-sm">Karthik Murugan</div>
            ...
            <div className="p-8 bg-[#0E1B30] rounded-3xl border border-slate-800 flex flex-col justify-between space-y-6">
              ...
              <div className="flex items-center gap-3 border-t border-slate-800 pt-4">
                <div className="w-10 h-10 rounded-full bg-emerald-500/20 flex items-center justify-center text-emerald-400 font-bold">SB</div>
                <div>
                  <div className="font-bold text-white text-sm">Siti Baidura</div>
            ...
            <div className="p-8 bg-[#0E1B30] rounded-3xl border border-slate-800 flex flex-col justify-between space-y-6">
              ...
              <div className="flex items-center gap-3 border-t border-slate-800 pt-4">
                <div className="w-10 h-10 rounded-full bg-blue-500/20 flex items-center justify-center text-blue-400 font-bold">WV</div>
                <div>
                  <div className="font-bold text-white text-sm">Wiliam V.</div>
      ...
      {/* 9. FOOTER KORPORAT MATANG GRED INDUSTRI */}
